...
<form action="employee/{{$employee->id}}" method="POST">
    ...
    <div class="mb-3 col-5">
      ...
      <input type="text" name="lname" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required value="{{$employee->lastName}}">
    </div>
    <div class="mb-3 col-5">
      ...
      <select name="company_id" id="" class="form-control">
        <option value="{{$employee->company_id}}" selected="selected">{{$employee->company_id}}</option>
